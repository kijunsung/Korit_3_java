...
/*
        주석(COMMENT) : Java프로그램의 경우 폴더 및 파일의 전체 코드를
        커파일 하는데, 거기서 오류가 하나라도 발생하면 전체 프로그램이 실행 x
...
//        System.out.println("안녕하세요, 제 이름은 기준성입니다");
...
//      checkFlag2 = true; ->얘는 checkFlag2가 처음 등장하는데
        ...
        //2. 문자 자료형 변수 char
//        char name1 = '안';   //문자를 입력할 때에는 작은 따옴표로 감싼다.
...
//        System.out.println("" + name2 + name1 + name3);
        ...
        문자(하나짜리)를 세번 더했을 경우 더이상 문자가 아니라 문자열로 인식되기 때문에
        원하는 방식대로 출력이 되지 않습니다.

        그렇기 때문에 저희는 sout()안에 ""를 넣어줌으로써, ()안의 부분이 전체
        문자'열'로 인식되게끔 꼼수를 부린 부분이 58번 라인에 해당합니다.

        여기서 알 수 있는 점은 sout()의 가장 먼저 나온 데이터의
         */
        System.out.println("123" + 1);
        ...
        String a = "제 이름은 안근수 입니다, 나이는 38세 입니다";
        ...
        /*
           ...
           snake Casse라고 해서 my_test_result와 같은 방식으로 표기합니다.
         */
        ...
        String name = "안근수";
        String major = "영어교육과";
        String job = "코리아 it아카데미 국비 강사";

        System.out.println(name);
        System.out.println(major);
        System.out.println(job);

        System.out.println("안녕하세요. 제이름은" + name + "이고, "+ major + "직업은" + job + "입니다");
        System.out.println();
        ...
        String name1 = "기준성";
        int age1 = 25;
        String major1 = "인공지능응용학과";
        String mbti1 = "intp";
        System.out.println("저는 코리아 it 아카데미 3월 국비과정을 수료하고 있는 " + name1 + "입니다, 나이는" + age1 + "살입니다.\n");
        System.out.println("제\t 전공은" + major1 + "이며, mbti는" + mbti1 + "입니다. 열심히 할게요" );

        //이상의 선언된 변수를 기준으로 적절한 여러분의 데이터로 초기화하였고,
        //콘솔창에 다음과 같이 입력될 수 있도록 작성하시오.

        //저는 코리아 it아카데미 3월 국비 과정을 수강하고 있는 누구누구입니다. --살입니다.
        //제 전공은 어쩌고저쩌고과이며, mbti는 ~입니다. 열심히 할게요
