...
public class JSON2 {
    public static void main(String[] args) {
        ...
        //map에다 entry 집어넣는 method -> .put();
        map.put("productCode", "NT960XHA-KD72G");
        map.put("productName", "갤럭시 북 프로 5");

        String productJson = gsonBuilder.toJson(map);
        ...
        //json -> user
        //그러면 userJson을 User 클래스의 user2에 대입 하려면 어떡하면 될까요
