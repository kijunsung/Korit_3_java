...
public class Person {
    ...
    public void setName(String name) {
        ...
        //변경 전 이름:
        //변경 후 이름:
        //이 출력이되도록 하시오. 여기서 anme.length()를 응용하여 합니다.
        //그리고 이거 다 끝났으면 person1.setName("레오나르도 디카프리오")라고
        //입력하고, 불가능한 이름 입력입니다. 를 출력시키시오
        //그리고 person1.setName()에 여러분 이름을 입력하여
        //변경 전 이름 : 안근수
        //변경 후 이름 : 기준성 이 너올 수 았도록 작성하시오.
    ...
    public void setAge(int age) {
        // 0 미만, 200 초과의 값이 입력 됐을 경우 "불가능한 나이 입력입니다"
