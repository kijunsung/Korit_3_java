...
//            } else {
//                System.out.println("키가 작군요 ㅋㅋ");      //실행문 1-b
//            }
//            System.out.println("감사링 빨리 타쇼");      //실행문 1-2
//        } else {
...
//    }
        ...
        if (height >= 110) {
            ...
            if(age >=7) {
                System.out.println("바로 입장하이소");
            } else {
                System.out.println("어차피 어린놈이군요");
            }
            System.out.println("타이소");
        } else {
            System.out.println("다음에 타이소");
        }
